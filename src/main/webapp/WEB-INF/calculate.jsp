...
<div style="text-align: right;padding:5px;margin:5px 0px;background:#ccc;">
    <a class="btn2" href="${pageContext.request.contextPath}/calculate?language=en_US">Login (English)</a>

    <a class="btn2" href="${pageContext.request.contextPath}/calculate?language=ru_RU">Login (Rus)</a>
